...
expectStderr 0 nix search flake1 ^ | grepQuiet "Found 3 out of 3 matching packages."
expectStderr 0 nix search flake1 ^ | grepQuiet "legacyPackages.$system.xyzzy"
expectStderr 0 nix search flake1#foo ^ | grepQuiet "Found 1 out of 1 matching packages."
