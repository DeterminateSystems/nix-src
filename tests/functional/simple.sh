...
if test "$outPath" != "/foo/lfy1s6ca46rm5r6w4gg9hc0axiakjcno-dependencies.drv"; then
...
if test "$outPath" != "/foo/xxiwa5zlaajv6xdjynf9yym9g319d6mo-big-derivation-attr.drv"; then
