...
- [deriving path]{#string-context-element-derived-path}
  ...
  - [Constant string context elements]{#string-context-constant}
    ...
    >
    > ```nix
    > builtins.getContext (builtins.storePath "/nix/store/wkhdf9jinag5750mqlax6z2zbwhqb76o-hello-2.10")
    > ```
    > evaluates to
    > ```nix
    > {
  ...
  - [Output string context elements]{#string-context-output}
    ...
    > builtins.getContext
    >   (builtins.outputOf
    >     (builtins.storePath "/nix/store/fvchh9cvcr7kdla6n860hshchsba305o-hello-2.12.drv")
    >     "out")
    > ```
    > evaluates to
    > ```nix
    > {
    >   "/nix/store/fvchh9cvcr7kdla6n860hshchsba305o-hello-2.12.drv" = {
    >     outputs = [ "out" ];
    >   };
    > }
    > ```
