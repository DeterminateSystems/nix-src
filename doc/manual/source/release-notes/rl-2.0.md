    ...
    major features:
      ...
      - Unlike the legacy commands, it has a consistent way to refer to
        ...
        to a remote machine:
            ...
            nix copy --to ssh://machine /nix/store/0i2jd68mp5g6h2sa5k9c85rb80sn8hio-hello-2.10
    ...
    A number of low-level (“plumbing”) commands are also available:
      ...
      - `nix ls-store` and `nix
        ...
        e.g.
            ...
            nix ls-store --store https://cache.nixos.org/ -lR /nix/store/0i2jd68mp5g6h2sa5k9c85rb80sn8hio-hello-2.10
