...
This release is based on upstream Nix 2.35.2, which includes numerous new features and performance improvements. See the [upstream release notes](../release-notes/rl-2.35.md) for more details.
...
**Full Changelog**: [v3.21.9...v3.22.1](https://github.com/DeterminateSystems/nix-src/compare/v3.21.9...v3.22.1)
