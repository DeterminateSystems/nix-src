...
* Repair a store path, after determining that it is corrupt:
  ...
  ```console
  # nix store verify /nix/store/yb5q57zxv6hgqql42d5r8b5k5mcq6kao-hello-2.10
  path '/nix/store/yb5q57zxv6hgqql42d5r8b5k5mcq6kao-hello-2.10' was
  ...
  # nix store repair /nix/store/yb5q57zxv6hgqql42d5r8b5k5mcq6kao-hello-2.10
  ```
