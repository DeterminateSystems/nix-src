    ...
    .doc = R"(
      ...
      **Fetch a content-addressed store path**
      ...
      builtins.fetchClosure {
        ...
        fromPath = /nix/store/ldbhlwhh39wha58rm61bkiiwm6j7211o-git-2.33.1;
      }
      ```
      ...
      **Fetch any store path and rewrite it to a fully content-addressed store path**
      ...
      builtins.fetchClosure {
        fromStore = "https://cache.nixos.org";
        fromPath = /nix/store/r2jd6ygnmirm2g803mksqqjm4y39yi6o-git-2.33.1;
        toPath = /nix/store/ldbhlwhh39wha58rm61bkiiwm6j7211o-git-2.33.1;
      }
      ```
      ...
      ```console
      # nix store make-content-addressed --from https://cache.nixos.org /nix/store/r2jd6ygnmirm2g803mksqqjm4y39yi6o-git-2.33.1
      rewrote '/nix/store/r2jd6ygnmirm2g803mksqqjm4y39yi6o-git-2.33.1' to '/nix/store/ldbhlwhh39wha58rm61bkiiwm6j7211o-git-2.33.1'
      ```
