...
LockFileV7::LockFileV7(const fetchers::Settings & fetchSettings, std::string_view contents, std::string_view path)
{
    auto json = [=] {
        try {
...
std::string LockFileV7::diff(const LockFileV7 & oldLocks, const LockFileV7 & newLocks)
{
